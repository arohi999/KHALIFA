...
time.sleep(2)
#os.system('clear')
print("\033[97;1m[\x1b[38;5;50m+\033[97;1m]\x1b[38;5;50m FACEBOOK PAGE ..!")
os.system("espeak -a 300 \"FOLLOW , MY FACEBOOK, PAGE ,\"")
time.sleep(2)
os.system(f'xdg-open https://www.facebook.com/Emonkhalifax')
os.system(f'xdg-open https://www.facebook.com/djpagladirector')
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[NAPA🩸-ON]-{P}[{H}{loop}{P}]-[{H}{len(id)}{P}]-[{H}OK{bo}-{H}{ok}{P}]-[{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
